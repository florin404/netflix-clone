...
function PlansScreen() {
    ...
    const loadCheckout = async (priceId) => {
        ...
        docRef.onSnapshot(async(snap) => {
            ...
            if (sessionId) {
                ...
                const stripe = await loadStripe('pk_test_51IQaZbEemFIkz8ZHKWG1tG0Z4X7RoM5nJiTLGNMRwbSw6filSmdoGKraPJuYPema6Wti8KTknWwIAcofcI5MgaG500qTozUMKf');
    ...
    return (
        <div className="plansScreen">
            <br/>
            {subscription && <p>Revenwal date: {new Date(subscription?.current_period_end * 1000).toLocaleDateString()} </p> }
